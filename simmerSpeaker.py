...
with open('DeviceID/deviceIdSpeaker.txt', 'r') as file:
    code = file.read()

# Generate complete command 
speaker_cmd = (cmd_prefix + port + "/streamRedirections/monitoring/deviceId/%7B0.0.0.00000000%7D.%7B" + code + "%7D").strip()
